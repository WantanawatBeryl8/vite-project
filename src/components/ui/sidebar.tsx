  ...
  (
    ...
    return (
      ...
      >
        ...
        <div
          className={cn(
            'absolute top-16 z-10 hidden h-svh transition-[left,right,width] duration-200 ease-linear md:flex',
            side === 'left'
...
>(({ className, asChild = false, ...props }, ref) => {
  ...
  return (
    <Comp
      ...
      className={cn(
        'ring-sidebar-ring flex h-8 shrink-0 items-center rounded-md px-2 font-medium outline-none transition-[margin,opa] duration-200 ease-linear focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0',
